...
<p align="center">
  <img src="https://skillicons.dev/icons?i=laravel,php,postgres,redis,vue,ts,tailwind,docker,linux,rust,go,py" alt="Laravel, PHP, PostgreSQL, Redis, Vue, TypeScript, Tailwind, Docker, Linux, Rust, Go, Python" />
</p>
